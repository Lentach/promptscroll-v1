...
import { X, Save, AlertCircle, Tag, Lightbulb, Brain, Bot } from 'lucide-react';
...
const GPT4Icon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" className={className} fill="currentColor">
    ...
    <text x="12" y="16" textAnchor="middle" fontSize="6" fill="currentColor" fontWeight="bold">
      4
    </text>
  </svg>
);
...
export function AddPromptForm({ isOpen, onClose, onSuccess }: AddPromptFormProps) {
  ...
  // Difficulty options centralised
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!parsed.success) {
        ...
        setFieldErrors(errs);
        throw new Error('Please correct highlighted errors');
      }
      setFieldErrors({});
      ...
      const detectedCats = detectCategories(
      ...
      const fullText =
        `${formData.title} ${formData.description} ${formData.content}`.toLowerCase();
  ...
  const handleChange = (field: keyof PromptFormInput, value: string) => {
    setFormData((prev: PromptFormInput) => ({ ...prev, [field]: value }));
  ...
  const handleCategoriesChange = (values: string[]) => {
    setFormData((prev: PromptFormInput) => ({ ...prev, category_ids: values }));
  };
  ...
  return (
    ...
    >
      <div
        className="bg-slate-900/95 backdrop-blur-md rounded-2xl border border-white/10 w-full max-w-4xl max-h-[90vh] overflow-y-auto"
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-white/10">
          <div className="flex items-center space-x-3">
            ...
            <div
              className={`w-10 h-10 rounded-xl bg-gradient-to-r ${currentModelConfig.color} flex items-center justify-center transition-all duration-300`}
            >
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">
                Share your amazing AI prompt for{' '}
                <span className={`font-medium ${currentModelConfig.textColor}`}>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-white/5 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-colors text-white placeholder-gray-400 border ${fieldErrors.title ? 'border-red-500' : 'border-white/10'}`}
                  required
                />
                {fieldErrors.title && (
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={8}
                  className={`w-full px-4 py-3 bg-white/5 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-colors text-white placeholder-gray-400 resize-none border ${fieldErrors.content ? 'border-red-500' : 'border-white/10'}`}
                  required
                />
                {fieldErrors.content && (
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div>
                  ...
                  <div
                    className={`mt-2 flex items-center space-x-2 px-3 py-2 ${currentModelConfig.bgColor} rounded-lg`}
                  >
                ...
                <div className="hidden">
                  ...
                  <div>
                          ...
                          <button
                            ...
                            onClick={() =>
                              handleCategoriesChange(
                                isActive
                                  ? formData.category_ids.filter((id: string) => id !== category.id)
                    ...
                    <p className="text-xs text-gray-400 mb-3">
                      Tagi zostaną wygenerowane automatycznie na podstawie treści prompta, kategorii
                      i wybranego modelu AI.
                    </p>
                  </div>
                </div>
              </div>
