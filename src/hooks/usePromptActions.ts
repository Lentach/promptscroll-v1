...
export function usePromptActions({ onUpdate }: UsePromptActionsOptions = {}) {
  ...
  const likePrompt = useCallback(
    async (promptId: string, currentLikes: number) => {
  ...
  const dislikePrompt = useCallback(
    async (promptId: string, currentDislikes: number) => {
  ...
  const copyPrompt = useCallback(
    async (promptId: string, content: string, currentUses: number) => {
  ...
  const recordUse = useCallback(
    async (promptId: string, currentUses: number) => {
