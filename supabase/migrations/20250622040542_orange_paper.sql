/*
  ...
  3. Sample Data
    - Content-based categories only (no AI model names)
...
-- Insert content-based categories only (NO AI MODEL NAMES)
...
-- Insert high-quality sample prompts with proper content-based categories
INSERT INTO prompts (
  title, 
  content, 
  description, 
